...
class ConfigFuzzer:
    ...
    def _generate_value_for_type(self, type_hint: type) -> Any:
        ...
        if type_hint == bool:
            ...
            return self._generate_value_for_type(random.choice(type_hint.__args__))
        elif get_origin(type_hint) is tuple:
            return tuple(map(self._generate_value_for_type, type_hint.__args__))
            ...
            def dummy_function(*args, **kwargs) -> return_type:
                return self._generate_value_for_type(return_type)
